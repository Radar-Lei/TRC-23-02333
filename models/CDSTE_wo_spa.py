...
from submodules import CondObsEmbedding, Conv1d_with_init, TemResidualBlock
import torch.fft
...
class Model(nn.Module):
    def __init__(self, configs, inputdim = 2):
        ...
        self.cond_embedding = CondObsEmbedding(configs.locations,
                                            configs.d_model,
        ...
        self.trans_layers = nn.ModuleList(
            [
                TemResidualBlock(
                    side_dim=1+configs.spa_pos_emb_dim+configs.d_model * 2,
